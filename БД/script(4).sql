...
COPY Основные_стат_показатели.Население(Субъект_РФ, Год, Добыча_полезных_ископаемых, Обрабатывающие_производства, Произв_распред_электр_газа_воды, Водоснабж_водоотвед_утилизация) FROM 'D:\coursework\tables\industry.csv' DELIMITER ';' CSV header;
...
INSERT INTO Основные_стат_показатели.Население (ФО, Субъект_РФ,Год, Добыча_полезных_ископаемых, Обрабатывающие_производства, Произв_распред_электр_газа_воды, Водоснабж_водоотвед_утилизация )
...
END, Субъект_РФ, Год,  Добыча_полезных_ископаемых, Обрабатывающие_производства, Произв_распред_электр_газа_воды, Водоснабж_водоотвед_утилизация FROM Основные_стат_показатели.Население;
--SELECT * FROM Основные_стат_показатели.Население;
DELETE FROM Основные_стат_показатели.Население
WHERE ФО ISNULL;
